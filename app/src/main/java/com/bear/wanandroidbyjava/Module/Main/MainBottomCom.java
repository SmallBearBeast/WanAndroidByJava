...
public class MainBottomCom extends ActivityComponent implements View.OnClickListener {
    ...
    public MainBottomCom(Lifecycle lifecycle) {
        super(lifecycle);
    }
    ...
    public void onClick(View v) {
        ...
        if (lastClickViewId != v.getId() || curTs - lastClickTs > CLICK_INTERVAL) {
            if (viewId == R.id.homeTabItemView) {
                getComponent(MainContentCom.class).switchTab(MainContentCom.TAB_HOME);
            } else if (viewId == R.id.systemTabItemView) {
                getComponent(MainContentCom.class).switchTab(MainContentCom.TAB_SYSTEM);
            } else if (viewId == R.id.publicTabItemView) {
                getComponent(MainContentCom.class).switchTab(MainContentCom.TAB_PUBLIC);
            } else if (viewId == R.id.projectTabItemView) {
                getComponent(MainContentCom.class).switchTab(MainContentCom.TAB_PROJECT);
            } else if (viewId == R.id.personalTabItemView) {
                getComponent(MainContentCom.class).switchTab(MainContentCom.TAB_PERSONAL);
            }
        } else {
            if (viewId == R.id.homeTabItemView) {
                getComponent(HomeListCom.class).scrollToTop();
            } else if (viewId == R.id.systemTabItemView) {
                getComponent(SystemCom.class).scrollToTop();
            } else if (viewId == R.id.publicTabItemView) {
                getComponent(PublicCom.class).scrollToTop();
            } else if (viewId == R.id.projectTabItemView) {
                getComponent(ProjectCom.class).scrollToTop();
            }
        }
